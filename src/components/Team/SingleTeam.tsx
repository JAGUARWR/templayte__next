...
const SingleTeam = ({ team }: { team: TeamType }) => {
  const { image, name, designation, telegramLink, } =
    team;
  return (
  ...
  >
    <path
      // Это path, который идеально вписывается в 18x18, 
      // центрирован и имеет узнаваемую форму самолетика.
      d="M15.5 3.375L2.37 8.514a.35.35 0 0 0-.01.628l2.9 1.16 6.06-4.017a.4.4 0 0 1 .45.078.4.4 0 0 1-.078.45L6.9 12.01l2.9 1.957c.28.188.67.12.83-.153L15.5 3.375Z"
      fill=""
    /></svg>
            </Link>
            {/* 
