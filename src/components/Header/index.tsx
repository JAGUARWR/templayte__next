...
const Header = () => {
  ...
  // Navbar toggle
  const isActive = (p: string) => (p === "/" ? pathUrl === "/" : pathUrl.startsWith(p));
              ...
              >
                {pathUrl !== "/" ? (
                  ...
                  <>
                    <Image
                      src={`${sticky
                        ? "/images/logo/DarkLogo.svg"
                        : "/images/logo/WhiteLogo.svg"
                        }`}
                      alt="logo"
                      width={140}
                      height={30}
                        ...
                        <li key={index} className="group relative">
                          <Link
                            ...
                            className={[
                              ...
                              // базовый цвет ссылки с учётом страницы и sticky
                              // базовый цвет ссылки с учётом страницы и sticky (фикс для светлой темы на '/')
                              pathUrl === "/" && !sticky
                                ? "text-dark dark:text-white lg:text-white"
                                : "text-dark group-hover:text-primary dark:text-white dark:group-hover:text-primary",

                              // активность (подсветка только не для '/')
                              (menuItem.path !== "/" &&
                        ...
                        <li className="submenu-item group relative" key={index}>
                          {pathUrl !== "/" ? (
                            ...
                            <button
                              onClick={() => handleSubmenu(index)}
                              className={[
                                "ud-menu-scroll flex items-center justify-between py-2 text-base lg:inline-flex lg:px-0 lg:py-6",
                                sticky
                                  ? "text-dark group-hover:text-primary dark:text-white dark:group-hover:text-primary"
                                  : "text-white"
                              ].join(" ")}
                          ...
                          <div
                            className={[
                              "submenu relative left-0 top-full w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full",
